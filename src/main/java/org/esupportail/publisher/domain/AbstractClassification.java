...
public abstract class AbstractClassification extends AbstractAuditingEntity
    ...
    /** This field corresponds to the database column hidden_if_empty. */
    @Column(length = 1, nullable = false, name = "hidden_if_empty")
    ...
    @QueryInit({"context.reader", "context.organization", "context.redactor", "context.reader.authorizedTypes"})
