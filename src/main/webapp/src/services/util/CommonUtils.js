...
const sizeFormat = ['KB', 'MB', 'GB', 'TB', 'PB', 'EB', 'ZB', 'YB']
...
class CommonUtils {
  ...
  isArray(arr) {
    return Array.isArray(arr) || Array.isArray(arr)
  }
  ...
  equals(o1, o2) {
    ...
    if (t1 === t2 && t1 === 'object') {
      if (this.isArray(o1)) {
        ...
        for (key in o2) {
          if (!(key in keySet) && key.charAt(0) !== '$' && this.isDefined(o2[key]) && !this.isFunction(o2[key]))
            return false
        }
        return true
      }
