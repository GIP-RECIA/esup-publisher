...
.custom-toast-item.custom-toast-item-top,
.custom-toast-item.custom-toast-item-bottom {
  align-self: center;
}

.custom-toast-item.custom-toast-item-top-right,
.custom-toast-item.custom-toast-item-bottom-right {
  align-self: flex-end;
}

.custom-toast-item.custom-toast-item-top-left,
.custom-toast-item.custom-toast-item-bottom-left {
