  ...
  <div class="container-fluid justify-content-end">
    <div class="navbar-brand">
      ...
      <a class="navbar-brand"
        ><span>{{ $t('global.title') }}</span> <span class="navbar-version">v{{ backVersion }}</span></a
      >
    </div>
          ...
          <ul class="dropdown-menu">
            <li :class="{ active: isPageNameIncludes('organization') }">
              <router-link to="/organization" class="dropdown-item"
                ><span class="fas fa-asterisk"></span> &#xA0;<span>{{ $t('global.menu.entities.organization') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('filter') }">
              <router-link to="/filter" class="dropdown-item"
                ><span class="fas fa-asterisk"></span> &#xA0;<span>{{ $t('global.menu.entities.filter') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('reader') }">
              <router-link to="/reader" class="dropdown-item"
                ><span class="fas fa-asterisk"></span> &#xA0;<span>{{ $t('global.menu.entities.reader') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('redactor') }">
              <router-link to="/redactor" class="dropdown-item"
                ><span class="fas fa-asterisk"></span> &#xA0;<span>{{ $t('global.menu.entities.redactor') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('publisher') }">
              <router-link to="/publisher" class="dropdown-item"
                ><span class="fas fa-asterisk"></span> &#xA0;<span>{{ $t('global.menu.entities.publisher') }}</span></router-link
              >
            </li>
          </ul>
        </li>
          ...
          <ul class="dropdown-menu">
            <li :class="{ active: isPageNameIncludes('metrics') }">
              <router-link to="/metrics" class="dropdown-item"
                ><span class="fas fa-gauge"></span> &#xA0;<span>{{ $t('global.menu.admin.metrics') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('health') }">
              <router-link to="/health" class="dropdown-item"
                ><span class="fas fa-heart"></span> &#xA0;<span>{{ $t('global.menu.admin.health') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('configuration') }">
              <router-link to="/configuration" class="dropdown-item"
                ><span class="fas fa-list"></span> &#xA0;<span>{{ $t('global.menu.admin.configuration') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('audits') }">
              <router-link to="/audits" class="dropdown-item"
                ><span class="fas fa-bell"></span> &#xA0;<span>{{ $t('global.menu.admin.audits') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('logs') }">
              <router-link to="/logs" class="dropdown-item"
                ><span class="fas fa-tasks"></span> &#xA0;<span>{{ $t('global.menu.admin.logs') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('docs') }">
              <router-link to="/docs" class="dropdown-item"
                ><span class="fas fa-book"></span> &#xA0;<span>{{ $t('global.menu.admin.apidocs') }}</span></router-link
              >
            </li>
            <li :class="{ active: isPageNameIncludes('console') }" v-if="environment === 'development'">
              <a target="_blank" :href="`${dbConsoleUrl}`" class="dropdown-item"
                ><span class="fas fa-hdd"></span> &#xA0;<span>{{ $t('global.menu.admin.database') }}</span></a
              >
            </li>
          </ul>
        </li>
