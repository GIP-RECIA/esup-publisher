  ...
  methods: {
    loadAll() {
      const query_params = {
        ...
        per_page: 20,
        owned: false,
        item_status: this.getEnumKey('PENDING'),
      }
...
<template>
  ...
  <div id="deleteItemConfirmation" ref="deleteModal" class="modal fade">
  ...
  <div id="validateItemConfirmation" ref="validateModal" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
