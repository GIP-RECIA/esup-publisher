              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div v-if="content.file" class="card">
                    <h4 class="card-header mt-0" v-if="content.file.type.match('image/*')">
                      {{ $t('media.inputfile.resizeauto') }}
                    </h4>
                    <h4 class="card-header mt-0" v-else-if="content.file.type.match('audio/*')">
                      {{ $t('media.inputfile.audio') }}
                    </h4>
                    <h4 class="card-header mt-0" v-else-if="content.file.type.match('video/*')">
                    ...
                    <div class="card-body">
                      <div v-if="content.file && fileInputError === null">
                        ...
                        <audio controls v-else-if="content.file.type.match('audio/*')" :src="getUrlFromBlob(content.file)" class="mw-100" />
                        <video controls v-else-if="content.file.type.match('video/*')" :src="getUrlFromBlob(content.file)" class="mw-100" />
