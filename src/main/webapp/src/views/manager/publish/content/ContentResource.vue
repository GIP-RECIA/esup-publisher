  ...
  <div>
    <div class="resourceForm">
      ...
      <div class="form-group">
        ...
        />
        <div class="invalid-feedback" v-if="formValidator.hasError('ressourceUrl', formErrors.REQUIRED)">
          {{ $t('entity.validation.required') }}
        </div>
        <div class="invalid-feedback" v-if="formValidator.hasError('ressourceUrl', formErrors.MAX_LENGTH)">
          {{ $t('entity.validation.maxlength', { max: '2048' }) }}
        </div>
        <div class="invalid-feedback" v-if="invalidRessourceUrl">
                  ...
                  <div class="form-group row">
                    <div class="col-md-auto">
                      <input
                        ...
                        ref="urlInput"
                      />
                      <div class="invalid-feedback" v-if="urlInputError === formErrors.MAX_LENGTH">
                        {{ $t('entity.validation.maxlength', { min: '2048' }) }}
                      </div>
                      <div class="invalid-feedback" v-if="urlInputError === 'invalidurl'">
                        {{ $t('entity.validation.url') }}
                      </div>
                    </div>
                    <div class="col-md-auto">
                      ...
                      >
                        <span class="fas fa-floppy-disk"></span>&nbsp;<span>{{ $t('entity.action.validate') }}</span>
                      </button>
                    </div>
                  </div>
                </div>
