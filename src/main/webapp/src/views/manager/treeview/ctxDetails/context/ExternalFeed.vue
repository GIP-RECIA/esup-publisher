...
<template>
  ...
  <dl class="row entity-details">
    <dt class="col-sm-5">
      <span>{{ $t('externalFeed.rssUrl') }}</span>
    </dt>
    <dd class="col-sm-7">
      <span>{{ context.rssUrl }}</span>
    </dd>
  </dl>
  <dl
    v-if="
  ...
  <dl class="row entity-details">
    <dt class="col-sm-5">
      <span>{{ $t('externalFeed.description') }}</span>
    </dt>
    <dd class="col-sm-7">
  ...
  <dl class="row entity-details">
    <dt class="col-sm-5">
      <span>{{ $t('externalFeed.accessView') }}</span>
    </dt>
    <dd class="col-sm-7">
