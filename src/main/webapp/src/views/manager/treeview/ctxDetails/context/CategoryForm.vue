          ...
          <div class="modal-body">
            ...
            >
              ...
              <input
                ...
                ref="iconUrlInput"
              />
              <div class="invalid-feedback" v-if="formValidator.hasError('iconUrl', formErrors.REQUIRED)">
                {{ $t('entity.validation.required') }}
              </div>
              <div class="invalid-feedback" v-if="formValidator.hasError('iconUrl', formErrors.MAX_LENGTH)">
            ...
            <div class="form-group" v-has-role="'ROLE_ADMIN'">
              ...
              <select class="form-select" id="accessView" name="accessView" v-model="editedContextAccessView" required>
                <option v-for="accessType in accessTypeList" :key="accessType.id" :value="accessType.name">
                  {{ $t(accessType.label) }}
                </option>
              </select>
              <div class="invalid-feedback" v-if="formValidator.hasError('accessView', formErrors.REQUIRED)">
                {{ $t('entity.validation.required') }}
              </div>
            </div>
            <div class="form-group" v-has-role="'ROLE_ADMIN'">
            ...
            <div class="form-group" v-has-role="'ROLE_ADMIN'">
              ...
              <select class="form-select" id="lang" name="name" v-model="editedContextLang" required>
                <option v-for="lang in langList" :key="lang.id" :value="lang.id">
                  {{ $t(lang.label) }}
                </option>
              </select>
              <div class="invalid-feedback" v-if="formValidator.hasError('lang', formErrors.REQUIRED)">
                {{ $t('entity.validation.required') }}
              </div>
            </div>
            <div class="form-group" v-has-role="'ROLE_ADMIN'">
              <label for="ttl" class="control-label">{{ $t('category.ttl') }}</label>
              <input type="number" class="form-control" name="ttl" id="ttl" v-model="editedContextTtl" required min="900" max="86400" />
              <div class="invalid-feedback" v-if="formValidator.hasError('ttl', formErrors.REQUIRED)">
                {{ $t('entity.validation.required') }}
              </div>
              <div class="invalid-feedback" v-if="formValidator.hasError('ttl', formErrors.MIN_VALUE)">
                {{ $t('entity.validation.min', { min: '900' }) }}
              </div>
              <div class="invalid-feedback" v-if="formValidator.hasError('ttl', formErrors.MAX_VALUE)">
