...
describe('dateUtils.js tests', () => {
  it('test 1 DateUtils - convertDateTimeFromServer function OK', () => {
    const result = DateUtils.convertDateTimeFromServer('09/12/2021')
    const expectResult = new Date('09/12/2021')
    expect(result).toStrictEqual(expectResult)
  })

  it('test 2 DateUtils - convertDateTimeFromServer function KO: no date provided', () => {
    const result = DateUtils.convertDateTimeFromServer()
    expect(result).toBe(null)
  })

  it('test 3 DateUtils - convertLocalDateFromServer function OK', () => {
    const result = DateUtils.convertLocalDateFromServer('2021-12-09')
    const expectResult = new Date('2021', '11', '09')
    expect(result).toStrictEqual(expectResult)
  })

  it('test 4 DateUtils - convertLocalDateFromServer function KO: no date provided', () => {
    const result = DateUtils.convertLocalDateFromServer()
    expect(result).toBe(null)
  })

  it('test 5 DateUtils - convertLocalDateToServer function OK', () => {
    const result = DateUtils.convertLocalDateToServer('2021-12-09')
    const expectResult = '2021-12-09'
    expect(result).toStrictEqual(expectResult)
  })

  it('test 6 DateUtils - convertLocalDateToServer function KO: no date provided', () => {
    const result = DateUtils.convertLocalDateToServer()
    expect(result).toBe(null)
  })

  it('test 7 DateUtils - addDaysToLocalDate function OK', () => {
    const result = DateUtils.addDaysToLocalDate(new Date('2021', '11', '09'), 1)
    const expectResult = new Date('2021', '11', '10')
    expect(result).toStrictEqual(expectResult)
  })

  it('test 8 DateUtils - addDaysToLocalDate function KO: no date provided', () => {
    const result = DateUtils.addDaysToLocalDate()
    expect(result).toBe(null)
  })

  it('test 9 DateUtils - addDaysToLocalDate function KO: no nbDays provided', () => {
    const result = DateUtils.addDaysToLocalDate(new Date('2021', '11', '09'))
  ...
  it('test 11 DateUtils - addDaysToLocalDate function KO: no valid date format provided', () => {
    const result = DateUtils.addDaysToLocalDate('2021-12-09', 1)
    expect(result).toStrictEqual(null)
  })

  it('test 12 DateUtils - convertToIntString function OK', () => {
    const result = DateUtils.convertToIntString(
  ...
  it('test 13 DateUtils - min function OK', () => {
    const date1 = DateUtils.convertDateTimeFromServer('09/12/2021')
    const date2 = DateUtils.convertDateTimeFromServer('09/12/2022')
